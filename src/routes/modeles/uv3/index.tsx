...
export default component$(() => {
  return (
    <>
      <section>
        <div class="h-[800px] flex justify-center items-center overflow-hidden">
        ...
        <h1 class="text-6xl font-bold text-center py-4 mb-24">La nouvelle UV3®</h1>
      </section>

      <section class="flex justify-between items-center mb-24">
        <div class="w-2/3">
          <h2 class="text-4xl font-bold mb-8">Les avantages UV3®</h2>
        ...
        <img src="/img/cutrightlogo.svg" alt="Logo coupé droit OPTA" />
      </section>

      <section class="flex justify-center gap-24 bg-gray-200 py-8">
        <div>
      ...
      <section class="flex my-24">
        ...
        <div class="w-2/3 px-12 py-24">
          <h2 class="text-5xl font-bold mb-4">Un tableau de bord <br /> soigné</h2>
      ...
      <section class="flex my-24">
        <div class="w-2/3 px-12 py-24">
          <h2 class="text-5xl font-bold mb-4">Beaucoup <br/> de place</h2>
      ...
      <section class="flex my-24">
        ...
        <div class="w-2/3 px-12 py-24">
          <h2 class="text-5xl font-bold mb-4">Hydro-Hybrid technology</h2>
      ...
      <section class="flex justify-between bg-gray-200 py-8 px-12 mb-24">
        <div>
          <p class="text-4xl font-bold">Votre UV3® à partir de</p>
          <p class="text-6xl font-bold">370€<span class="text-xl">/mois</span></p>
        </div>
        <body>
