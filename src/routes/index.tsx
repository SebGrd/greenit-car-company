...
export default component$(() => {
  return (
    ...
    <section class="flex mb-24">
      <div class="w-1/2 bg-gray-300 px-12 py-24">
        <h1 class="text-6xl font-bold mb-12">La nouvelle <br/>UV3®</h1>
    ...
    <section class="py-24">
      <h2 class="text-6xl font-bold mb-4 text-center">UV3® Touring</h2>
    ...
    <section class="flex mb-24 py-24">
      <picture class="w-2/3">
      ...
      <div class="w-1/3 bg-gray-300 px-12 py-24">
        <h1 class="text-4xl font-bold mb-8">Des usines <br/>propres</h1>
